...
int abg_chans[] = {1,   7,   13,  2,   8,   3,   14,  9,   4,   10,  5,
				   11,  6,   12,  36,  38,  40,  42,  44,  46,  48,  50,
				   52,  54,  56,  58,  60,  62,  64,  100, 102, 104, 106,
				   108, 110, 112, 114, 116, 118, 120, 122, 124, 126, 128,
				   132, 134, 136, 138, 140, 142, 144, 149, 151, 153, 155,
				   157, 159, 161, 165, 169, 173, 0};
...
struct globals
{
	...
	// client status
	int numstas; /* number of Stations on the current list */
	int maxnumstas; /* maximum nubers of APs on the list */
	int maxstas; /* number of all APs found */
	/*
	...
	int output_format_tcp; // added dump to tcp flag
	pthread_t input_tid;
	int sort_by;
	int sort_inv;
	int start_print_ap;
